...
function object2vrPlayer (A) {
  ...
  function yc (a, e) {
    ...
    b.__div.onclick = function() {
      var zone_img = document.getElementById('zone-img')
      var zone_txt = document.getElementById('zone-txt')
      zone_img.setAttribute('src', e.img)
      console.log(e)
      zone_img.style.visibility = 'inherit'
      zone_txt.innerHTML = e.txt
          ...
          function(a) {
            ...
            if (!L) {
              ...
              Wa()
                ...
                : ((a = b.pageX - e.x - 0.5 * D), (e = b.pageY - e.y - 0.5 * E))
              b.preventDefault()
              1 != b.scale &&
                ((Sa *= b.scale),
                  (b = n),
        ...
        for (e = a.firstChild; e;) {
          ...
          if ('hotspot' == e.nodeName) {
            g = {
              ...
              ; (b = e.getAttributeNode('contents')) &&
                (g.txt = b.nodeValue.toString())
              ; (b = e.getAttributeNode('img')) && (g.img = b.nodeValue.toString())
              ; (b = e.getAttributeNode('target')) &&
            ...
            if ((b = e.getAttributeNode('reuse'))) g.reuse = b.nodeValue
              ...
              ; (b = e.getAttributeNode('width')) && (g.w = b.nodeValue.toString())
              ; (b = e.getAttributeNode('height')) &&
